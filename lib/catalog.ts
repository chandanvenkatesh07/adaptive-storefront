...
export const CATALOG: Product[] = [
  ...
  // --- appliance buying (high-consideration shopper) ---
  { id: "sku_dishwasher_budget", name: "Front-Control Dishwasher, 55 dBA", brand: "BrightHome", price: 429.0, rating: 4.3, category: "Appliances", blurb: "A practical replacement dishwasher for tight budgets, with a stainless-look door and heated dry.", tags: ["appliance", "dishwasher", "kitchen", "compare", "budget", "upgrade"], inStock: true },
  { id: "sku_dishwasher_quiet_stainless", name: "Quiet Stainless Dishwasher, 44 dBA", brand: "Cascade", price: 749.0, rating: 4.7, category: "Appliances", blurb: "Quieter cycle, fingerprint-resistant stainless finish, and flexible racks for everyday family loads.", tags: ["appliance", "dishwasher", "kitchen", "compare", "quiet", "stainless", "upgrade"], inStock: true },
  { id: "sku_dishwasher_third_rack", name: "Premium Third-Rack Dishwasher, 42 dBA", brand: "Cascade", price: 999.0, rating: 4.8, category: "Appliances", blurb: "Premium quiet model with a third rack, stainless tub, and extra room for utensils and small bowls.", tags: ["appliance", "dishwasher", "kitchen", "compare", "quiet", "premium", "third-rack", "stainless"], inStock: true },
  { id: "sku_dishwasher_compact", name: "Compact 18 in. Dishwasher", brand: "BrightHome", price: 579.0, rating: 4.4, category: "Appliances", blurb: "Narrow dishwasher for apartments, galley kitchens, and remodels where a full-width unit won't fit.", tags: ["appliance", "dishwasher", "kitchen", "compact", "compare", "install"], inStock: true },
  { id: "sku_dishwasher_install_kit", name: "Dishwasher Installation Kit", brand: "Cascade", price: 24.98, rating: 4.6, category: "Appliances", blurb: "Cord, hose fittings, and basic hardware most replacements need before the installer arrives.", tags: ["appliance", "dishwasher", "kitchen", "install", "accessory"], inStock: true },
  { id: "sku_dishwasher_supply_line", name: "Dishwasher Water Supply Line, 6 ft.", brand: "Cascade", price: 13.47, rating: 4.5, category: "Plumbing", blurb: "Braided stainless supply line sized for a dishwasher replacement or kitchen upgrade.", tags: ["appliance", "dishwasher", "kitchen", "install", "plumbing", "accessory"], inStock: true },
  { id: "sku_dishwasher_detergent_pods", name: "Dishwasher Detergent Pods, 62-count", brand: "CleanForge", price: 18.99, rating: 4.7, category: "Cleaning", blurb: "A consumable add-on for the first month with the new dishwasher.", tags: ["appliance", "dishwasher", "kitchen", "consumable", "cleaning"], inStock: true },
  { id: "sku_appliance_cleaner", name: "Dishwasher & Appliance Cleaner Tablets", brand: "CleanForge", price: 8.99, rating: 4.5, category: "Cleaning", blurb: "Monthly cleaner tablets for odor, scale, and hard-water buildup.", tags: ["appliance", "dishwasher", "kitchen", "consumable", "cleaning"], inStock: true },
